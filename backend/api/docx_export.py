...
def create_docx_export(title, easy_read_content, original_markdown=None):
    ...
    try:
        ...
        disclaimer_run = disclaimer_para.add_run("This content was generated by a prototype created at the Office of Innovation at UNICEF for evaluation purposes only. The content was generated using Artificial Intelligence and may contain errors, inaccuracies or biases. It is not intended for use in UNICEF programs or by program partners.")
        ...
        run = acknowledgement_para.add_run("Symbols kindly provided by GlobalSymbols - making communication accessible worldwide")
        run.font.size = Pt(10)
